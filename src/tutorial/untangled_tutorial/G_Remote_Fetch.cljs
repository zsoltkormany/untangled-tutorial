(ns untangled-tutorial.G-Remote-Fetch
...
(defcard-doc
  ...
  parsing helpers in the `untangled-tutorial.parsing` namespace, this pares down to this:
...
(defcard-doc "
  ...
  If you look in `untangled-tutorial.core` you'll see an alternate tempid migration function that doesn't need id-key
